...
<form action="work5.php" method="post">
	...
	<th>好きな音楽</th>
		<td>
			<label for="pop">
				<input type="check" id="pop" name="music[]" value="pop" <?php if((isset($_POST["music"])) && $_POST["music"] == "pop"){echo "checked"; }; ?>>
				POP
			</label>
			<label for="rock">
				<input type="check" id="pop" name="music[]" value="rock" <?php if((isset($_POST["msuic"])) && $_POST["music"] == "rock"){echo "checked"; }; ?>>
				ロック
			</label>
			<label for="enka">
				<input type="check" id="pop" name="music[]" value="enka"<?php if((isset($_POST["music"])) && $_POST["music"] == "enka"){echo "checked"; }; ?>>
				演歌
			</label>
			<label for="randb">
				<input type="check" id="pop" name="music[]" value="randb" <?php if((isset($_POST["music"])) && $_POST["music"] == "randb"){echo "checked"; }; ?>>
				R&B
			</label>
		</td>
