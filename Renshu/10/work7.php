...
<body>
<form action="work7.php" method="post">
	...
	<th><label for="movie" class="col-md-3 control-label">好きな映画</label></th>
		<td>
			...
			<label for="sf">
				<input type="radio" id="sf" name="movie" value="sf" <?php if((isset($_POST["movie"])) && $_POST["movie"] == "sf"){echo "checked"; }; ?>>
				SF
			</label>
		</td>
	</tr>
	...
	<th>コメント</th>
		<td>
			<textarea class="form-control" id="comment" name="comment" rows="4" cols="40"><?php if(isset($_POST["comment"])){echo $_POST["comment"]; }; ?>
			</textarea>
		<td>
	</tr>
	<tr>
		<th>内緒</th>
			<td><input type="hidden" name="naisho" value="これは画面に表示されません">
				<span class="form-control"><?php if(isset($_POST["naisho"])){echo $_POST["naisho"]; }; ?></span>
			</td>
	</tr>
